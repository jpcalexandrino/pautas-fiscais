...
// Import Utils
import { formatCurrency, formatNumber, formatPercentage, formatKWh, formatMesReferencia } from '@shared/utils/formatters';
import {
  calcularTotalTributos, calcularPercentualTributos, calcularTarifaMedia,
  calcularConsumoTotal, calcularComposicaoFatura
} from '@shared/utils/calculations';
import { calculateEfficiencyScore } from '../utils/pdfScore';
import { formatAIInsights } from '../utils/pdfInsights';
import { calculateBenchmarks } from '../utils/pdfBenchmarks';
