import ProdutoRepository, { ProdutoRow } from '../../produtos/produtos.repository';
import DeParaProdutoEstadoRepository from '../../de-para/de-para.repository';
import { normalizeGtin, normalizeText, isDummyGtin } from '../../../shared/utils/normalize';
import type { PautaItemExtraido } from './PautaValidator';
import { stripAnnotations } from '../../../infrastructure/ocr/brandSlugs';
import { parseBatchDescription, findMatchingProducts } from '../../../shared/utils/batchMatcher';

export { stripAnnotations } from '../../../infrastructure/ocr/brandSlugs';
